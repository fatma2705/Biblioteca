...
<body class="d-flex flex-column h-100">
	...
	<main class="flex-shrink-0">
		<div class="container">
			...
			<spring:hasBindErrors name="edit_autore_attr">
				<%-- alert errori --%>
			...
			<div class='card'>
				...
				<div class='card-body'>
					...
					<form:form modelAttribute="edit_autore_attr" method="post"
						action="${pageContext.request.contextPath }/autore/update"
						...
						<div class="col-md-6">
							...
							<spring:bind path="nome">
								<input type="text" name="nome" id="nome"
									...
									value="${edit_autore_attr.nome }" required>
							</spring:bind>
						...
						<div class="col-md-6">
							...
							<spring:bind path="cognome">
								<input type="text" name="cognome" id="cognome"
									...
									value="${edit_autore_attr.cognome }" required>
							</spring:bind>
							<form:errors path="cognome" cssClass="error_field" />
						</div>

						<div class="col-md-6">
							<label for="nomeArte" class="form-label">Nome Arte <span
								class="text-danger">*</span></label>
							<spring:bind path="nomeArte">
								<input type="text"
									class="form-control ${status.error ? 'is-invalid' : ''}"
									name="nomeArte" id="nomeArte"
									placeholder="Inserire il nome arte"
									value="${edit_autore_attr.nomeArte }" required>
							</spring:bind>
							<form:errors path="nomeArte" cssClass="error_field" />
						</div>

						<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date'
							value='${edit_autore_attr.dataNascita}' />
						<div class="col-md-3">
